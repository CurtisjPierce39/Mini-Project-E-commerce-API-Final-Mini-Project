...
class CustomerForm extends Component {
    ...
    componentDidUpdate(prevProps) {
        if (prevProps.customerId !== this.props.customerId) {
            ...
            if (this.props.customerId) {
                axios.put(`http://127.0.0.1:5000/customers/${this.state.selectedCustomerId}`)
                    .then(response => {
                        const customerData = response.data;
                        this.setState({
                            name: customerData.name,
    ...
    render() {
        const { name, email, phone, error, errors, isLoading, showSuccessModal } = this.state;
        ...
        return (
            <Container>
                ...
                <h3>{ this.props.params.id ? 'Edit' : 'Add'} Customer</h3>
                ...
                <Modal show={showSuccessModal} onHide={this.closeModal}>
                    ...
                    <Modal.Body>
                        Ths customer has been successfully {this.state.selectedCustomerId ? 'updated' : 'added'}.
                    </Modal.Body>
                    <Modal.Footer>
